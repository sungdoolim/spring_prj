...
<body>
 <div id="mJoin_wrap">
  ...
  <form name="m" method="post" action="member_edit_ok" 
  onsubmit="return edit_check();">
   <table id="mJoin_t">
    ...
    <tr>
     ...
     class="input_box" value="${m.mem_name}"/>
     </td>
    </tr>
    <tr>
     <th>우편번호</th>
     ...
     class="input_box" readonly value="${m.mem_zip}" />-
    ...
    <tr>
     ...
     readonly value="${m.mem_addr}"/>
     </td>
    </tr>
    <tr>
     <th>나머지 주소</th>
     <td>
     <input name="mem_addr2" id="mem_addr2" size="36" 
     class="input_box" value="${m.mem_addr2}" />
     </td>
    </tr>
    <tr>
     <th>폰번호</th>
     ...
     maxlength="4" class="input_box" value="${m.mem_phone02}"/>-<input name="mem_phone03"
    ...
    <tr>
     ...
     class="input_box" value="${m.mail_id}" />
     @<input name="mail_domain" id="mail_domain" size="18"
     class="input_box" readonly value="${m.mail_domain}"/>
